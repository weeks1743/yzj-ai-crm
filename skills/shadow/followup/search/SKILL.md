...
- 当前未纳入查询支持的字段（如 地理位置(Lo_0, locationWidget) 当前未纳入影子技能查询支持、说明文字(De_0, describeWidget) 当前未纳入影子技能查询支持、说明文字(De_1, describeWidget) 当前未纳入影子技能查询支持 等 5 项）不能被近似拼装为查询条件。
...
## Search Coverage
- Base searchable params (15): `Te_4`, `Ra_2`, `Te_1`, `Te_0`, `Ra_0`, `Ra_1`, `_S_APPLY`, `Da_0`, `Da_1`, `owner_open_id`, `_S_SERIAL`, `_S_DATE`, `Ta_0`, `_S_DEPT`, `_S_TITLE`
...
- Not auto-generated for search: `地理位置(Lo_0, locationWidget)`, `说明文字(De_0, describeWidget)`, `说明文字(De_1, describeWidget)`, `说明文字(De_2, describeWidget)`, `附件(At_0, attachmentWidget)`
