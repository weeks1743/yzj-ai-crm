...
const RUNTIME_SKILL_DEFINITIONS: RuntimeBackedSkillDefinition[] = [
  {
    ...
    owner: '研究能力组',
    sla: 'P95 < 10 秒',
    summary: '通过独立 skill-runtime 执行公司研究，支持后台调试、事件查看和 markdown 产物下载。',
    requestPlaceholder:
  ...
  },
  {
    id: 'ext-003',
    label: '客户旅程地图',
    skillCode: 'ext.customer_journey_map_pm',
    runtimeSkillName: 'customer-journey-map',
    provider: SKILL_RUNTIME_PROVIDER_CODE,
    ...
    owner: '产品方法论组',
    sla: 'P95 < 20 秒',
    summary: '通过独立 skill-runtime 生成客户旅程地图，适合后台快速验证 PM 方法论类技能。',
    requestPlaceholder:
      '例如：基于一段 B2B SaaS onboarding 背景，输出从认知到留存的客户旅程地图。',
  },
  {
    id: 'ext-004',
    label: 'JTBD 分析',
    skillCode: 'ext.jobs_to_be_done_pm',
    runtimeSkillName: 'jobs-to-be-done',
    provider: SKILL_RUNTIME_PROVIDER_CODE,
    requiredDependencies: ['env:DEEPSEEK_API_KEY'],
    artifactKind: 'markdown',
    trigger: '需求澄清 / JTBD 框架分析',
    owner: '产品方法论组',
    sla: 'P95 < 20 秒',
    summary: '通过独立 skill-runtime 输出 JTBD 结构化分析，适合验证需求洞察与产品定位。',
    requestPlaceholder:
      '例如：围绕制造业 CRM 销售跟进场景，拆出功能性、情感性和社交性 jobs。',
  },
  {
    id: 'ext-005',
    label: '问题陈述',
    ...
    owner: '产品方法论组',
    sla: 'P95 < 20 秒',
    summary: '通过独立 skill-runtime 输出用户视角的问题陈述，适合需求澄清和方案评审前置准备。',
    requestPlaceholder:
  ...
  },
  {
    id: 'ext-006',
    label: 'SaaS 收入增长指标',
    skillCode: 'ext.saas_revenue_growth_metrics_pm',
    runtimeSkillName: 'saas-revenue-growth-metrics',
    provider: SKILL_RUNTIME_PROVIDER_CODE,
    requiredDependencies: ['env:DEEPSEEK_API_KEY'],
    artifactKind: 'markdown',
    trigger: 'SaaS 指标诊断 / 增长分析',
    owner: '产品方法论组',
    sla: 'P95 < 20 秒',
    summary: '通过独立 skill-runtime 生成 SaaS 收入增长指标分析，适合做经营指标解读与复盘。',
    requestPlaceholder:
      '例如：基于一组 MRR、churn、NRR 数据，输出关键指标解读和增长建议。',
  },
  {
    id: 'ext-008',
    label: 'super-ppt',
