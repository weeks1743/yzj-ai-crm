...
export interface YzjUserContext {
  appid: string;
  eid: string;
  username: string;
  userid: string;
...
export interface YzjTicketUserContextResponse {
  errorCode?: number;
  data?: Partial<YzjUserContext> | null;
  success?: boolean;
  error?: unknown;
}

export interface YzjAuthResolveTicketRequest {
  ticket?: string;
}
