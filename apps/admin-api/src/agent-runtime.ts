    ...
    return new StateGraph(MainAgentState)
      ...
      .addNode('execute_tool', async (state) => {
        ...
        return {
          ...
          contextFrame: result.contextFrame !== undefined ? result.contextFrame : state.contextFrame ?? null,
...
function normalizeGraphOutput(
  ...
  return {
    ...
    contextFrame: output.contextFrame !== undefined ? output.contextFrame : fallback.contextFrame ?? null,
